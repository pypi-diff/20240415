# Comparing `tmp/ktoolbox-0.5.1.tar.gz` & `tmp/ktoolbox-0.5.2.tar.gz`
...
### Comparing `ktoolbox-0.5.1/ktoolbox/api/base.py` & `ktoolbox-0.5.2/ktoolbox/api/base.py`
...
### Comparing `ktoolbox-0.5.1/PKG-INFO` & `ktoolbox-0.5.2/PKG-INFO`
