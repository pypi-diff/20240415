# Comparing `tmp/monisha-0.0.47.tar.gz` & `tmp/monisha-0.0.48.tar.gz`
...
### Comparing `monisha-0.0.47/Monisha/functions/function10.py` & `monisha-0.0.48/Monisha/functions/function10.py`
