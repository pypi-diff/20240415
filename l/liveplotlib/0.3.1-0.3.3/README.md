# Comparing `tmp/liveplotlib-0.3.1.tar.gz` & `tmp/liveplotlib-0.3.3.tar.gz`
...
### Comparing `liveplotlib-0.3.1/src/liveplotlib.egg-info/PKG-INFO` & `liveplotlib-0.3.3/src/liveplotlib.egg-info/PKG-INFO`
