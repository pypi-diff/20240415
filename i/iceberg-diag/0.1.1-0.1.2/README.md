# Comparing `tmp/iceberg_diag-0.1.1.tar.gz` & `tmp/iceberg_diag-0.1.2.tar.gz`
...
+gzip compressed data, was "iceberg_diag-0.1.2.tar", max compression
```

## Comparing `iceberg_diag-0.1.1.tar` & `iceberg_diag-0.1.2.tar`
...
+-rw-r--r--   0        0        0     1074 2024-01-29 10:14:36.487779 iceberg_diag-0.1.2/LICENSE
+-rw-r--r--   0        0        0     2468 2024-04-15 12:29:04.592228 iceberg_diag-0.1.2/README.md
+-rw-r--r--   0        0        0       84 2024-02-02 14:42:34.387856 iceberg_diag-0.1.2/icebergdiag/__init__.py
+-rw-r--r--   0        0        0     8520 2024-04-15 13:32:57.762385 iceberg_diag-0.1.2/icebergdiag/cli.py
+-rw-r--r--   0        0        0        0 2024-01-29 10:14:36.488312 iceberg_diag-0.1.2/icebergdiag/diagnostics/__init__.py
+-rw-r--r--   0        0        0     7901 2024-04-15 14:05:50.003636 iceberg_diag-0.1.2/icebergdiag/diagnostics/manager.py
+-rw-r--r--   0        0        0     1831 2024-04-15 12:29:04.593438 iceberg_diag-0.1.2/icebergdiag/diagnostics/requester.py
+-rw-r--r--   0        0        0     3785 2024-02-02 09:54:31.118015 iceberg_diag-0.1.2/icebergdiag/diagnostics/response.py
+-rw-r--r--   0        0        0     3568 2024-04-15 12:29:04.593778 iceberg_diag-0.1.2/icebergdiag/exceptions.py
+-rw-r--r--   0        0        0        0 2024-01-29 10:14:36.488934 iceberg_diag-0.1.2/icebergdiag/metrics/__init__.py
+-rw-r--r--   0        0        0      659 2024-02-02 09:54:31.118752 iceberg_diag-0.1.2/icebergdiag/metrics/table.py
+-rw-r--r--   0        0        0     6196 2024-02-02 09:54:31.119249 iceberg_diag-0.1.2/icebergdiag/metrics/table_metric.py
+-rw-r--r--   0        0        0     8647 2024-02-02 11:12:31.424532 iceberg_diag-0.1.2/icebergdiag/metrics/table_metrics.py
+-rw-r--r--   0        0        0     1602 2024-01-29 10:14:36.489494 iceberg_diag-0.1.2/icebergdiag/metrics/table_metrics_displayer.py
+-rw-r--r--   0        0        0     1972 2024-04-14 15:15:22.316705 iceberg_diag-0.1.2/icebergdiag/utils.py
+-rw-r--r--   0        0        0      710 2024-04-15 14:10:08.519782 iceberg_diag-0.1.2/pyproject.toml
+-rw-r--r--   0        0        0     3319 1970-01-01 00:00:00.000000 iceberg_diag-0.1.2/PKG-INFO
```

### Comparing `iceberg_diag-0.1.1/LICENSE` & `iceberg_diag-0.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `iceberg_diag-0.1.1/README.md` & `iceberg_diag-0.1.2/README.md`
...
### Comparing `iceberg_diag-0.1.1/icebergdiag/cli.py` & `iceberg_diag-0.1.2/icebergdiag/cli.py`
...
### Comparing `iceberg_diag-0.1.1/icebergdiag/diagnostics/manager.py` & `iceberg_diag-0.1.2/icebergdiag/diagnostics/manager.py`
...
### Comparing `iceberg_diag-0.1.1/icebergdiag/diagnostics/requester.py` & `iceberg_diag-0.1.2/icebergdiag/diagnostics/requester.py`
...
### Comparing `iceberg_diag-0.1.1/icebergdiag/diagnostics/response.py` & `iceberg_diag-0.1.2/icebergdiag/diagnostics/response.py`

 * *Files identical despite different names*

### Comparing `iceberg_diag-0.1.1/icebergdiag/exceptions.py` & `iceberg_diag-0.1.2/icebergdiag/exceptions.py`
...
### Comparing `iceberg_diag-0.1.1/icebergdiag/metrics/table.py` & `iceberg_diag-0.1.2/icebergdiag/metrics/table.py`

 * *Files identical despite different names*

### Comparing `iceberg_diag-0.1.1/icebergdiag/metrics/table_metric.py` & `iceberg_diag-0.1.2/icebergdiag/metrics/table_metric.py`

 * *Files identical despite different names*

### Comparing `iceberg_diag-0.1.1/icebergdiag/metrics/table_metrics.py` & `iceberg_diag-0.1.2/icebergdiag/metrics/table_metrics.py`

 * *Files identical despite different names*

### Comparing `iceberg_diag-0.1.1/icebergdiag/metrics/table_metrics_displayer.py` & `iceberg_diag-0.1.2/icebergdiag/metrics/table_metrics_displayer.py`

 * *Files identical despite different names*

### Comparing `iceberg_diag-0.1.1/icebergdiag/utils.py` & `iceberg_diag-0.1.2/icebergdiag/utils.py`

 * *Files identical despite different names*

### Comparing `iceberg_diag-0.1.1/pyproject.toml` & `iceberg_diag-0.1.2/pyproject.toml`
...
### Comparing `iceberg_diag-0.1.1/PKG-INFO` & `iceberg_diag-0.1.2/PKG-INFO`
