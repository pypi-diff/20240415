# Comparing `tmp/ReverseBox-0.6.7.tar.gz` & `tmp/ReverseBox-0.7.0.tar.gz`
...
### Comparing `ReverseBox-0.6.7/ReverseBox.egg-info/SOURCES.txt` & `ReverseBox-0.7.0/ReverseBox.egg-info/SOURCES.txt`
