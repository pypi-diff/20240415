# Comparing `tmp/codemodder-0.90.0.tar.gz` & `tmp/codemodder-0.91.0.tar.gz`
...
### Comparing `codemodder-0.90.0/.github/workflows/autoformat-pixeebot-prs.yaml` & `codemodder-0.91.0/.github/workflows/autoformat-pixeebot-prs.yaml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.github/workflows/codemod_pygoat.yml` & `codemodder-0.91.0/.github/workflows/codemod_pygoat.yml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.github/workflows/deploy_to_pypi.yml` & `codemodder-0.91.0/.github/workflows/deploy_to_pypi.yml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.github/workflows/integration_test.yml` & `codemodder-0.91.0/.github/workflows/integration_test.yml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.github/workflows/lint.yml` & `codemodder-0.91.0/.github/workflows/lint.yml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.github/workflows/pre-commit-autoupdate.yml` & `codemodder-0.91.0/.github/workflows/pre-commit-autoupdate.yml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.github/workflows/sonar_pixee.yml` & `codemodder-0.91.0/.github/workflows/sonar_pixee.yml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.github/workflows/test.yml` & `codemodder-0.91.0/.github/workflows/test.yml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.gitignore` & `codemodder-0.91.0/.gitignore`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/.pre-commit-config.yaml` & `codemodder-0.91.0/.pre-commit-config.yaml`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/CHANGELOG.md` & `codemodder-0.91.0/CHANGELOG.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/CONTRIBUTING.md` & `codemodder-0.91.0/CONTRIBUTING.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/LICENSE` & `codemodder-0.91.0/LICENSE`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/Makefile` & `codemodder-0.91.0/Makefile`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/PKG-INFO` & `codemodder-0.91.0/PKG-INFO`
...
### Comparing `codemodder-0.90.0/README.md` & `codemodder-0.91.0/README.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/ci_tests/test_pygoat_findings.py` & `codemodder-0.91.0/ci_tests/test_pygoat_findings.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/img/base-codemod.jpg` & `codemodder-0.91.0/img/base-codemod.jpg`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/img/codemodder-dark.png` & `codemodder-0.91.0/img/codemodder-dark.png`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/img/codemodder-light.png` & `codemodder-0.91.0/img/codemodder-light.png`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/img/codemodder.png` & `codemodder-0.91.0/img/codemodder.png`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_django_json_response_type.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_django_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_django_receiver_on_top.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_django_receiver_on_top.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_exception_without_raise.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_exception_without_raise.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_fix_assert_tuple.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_fix_assert_tuple.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_fix_float_equality.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_fix_float_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_fix_missing_self_or_cls.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_fix_missing_self_or_cls.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_flask_json_response_type.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_flask_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_jinja2_autoescape.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_jinja2_autoescape.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_jwt_decode_verify.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_jwt_decode_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_literal_or_new_object_identity.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_literal_or_new_object_identity.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_numpy_nan_equality.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_numpy_nan_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_remove_assertion_in_pytest_raises.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_remove_assertion_in_pytest_raises.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_secure_random.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_secure_random.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_tempfile_mktemp.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_tempfile_mktemp.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/sonar/test_sonar_url_sandbox.py` & `codemodder-0.91.0/integration_tests/sonar/test_sonar_url_sandbox.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_add_requests_timeout.py` & `codemodder-0.91.0/integration_tests/test_add_requests_timeout.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_combine_startswith_endswith.py` & `codemodder-0.91.0/integration_tests/test_combine_startswith_endswith.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_dependency_manager.py` & `codemodder-0.91.0/integration_tests/test_dependency_manager.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_django_debug_flag_on.py` & `codemodder-0.91.0/integration_tests/test_django_debug_flag_on.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_django_json_response_type.py` & `codemodder-0.91.0/integration_tests/test_django_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_django_model_without_dunder_str.py` & `codemodder-0.91.0/integration_tests/test_django_model_without_dunder_str.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_django_receiver_on_top.py` & `codemodder-0.91.0/integration_tests/test_django_receiver_on_top.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_django_session_cookie_secure_off.py` & `codemodder-0.91.0/integration_tests/test_django_session_cookie_secure_off.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_exception_without_raise.py` & `codemodder-0.91.0/integration_tests/test_exception_without_raise.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_file_resource_leak.py` & `codemodder-0.91.0/integration_tests/test_file_resource_leak.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_assert_tuple.py` & `codemodder-0.91.0/integration_tests/test_fix_assert_tuple.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_dataclass_defaults.py` & `codemodder-0.91.0/integration_tests/test_fix_dataclass_defaults.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_deprecated_abstractproperty.py` & `codemodder-0.91.0/integration_tests/test_fix_deprecated_abstractproperty.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_deprecated_logging_warn.py` & `codemodder-0.91.0/integration_tests/test_fix_deprecated_logging_warn.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_empty_sequence_comparison.py` & `codemodder-0.91.0/integration_tests/test_fix_empty_sequence_comparison.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_float_equality.py` & `codemodder-0.91.0/integration_tests/test_fix_float_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_hasattr_call.py` & `codemodder-0.91.0/integration_tests/test_fix_hasattr_call.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_missing_self_or_cls.py` & `codemodder-0.91.0/integration_tests/test_fix_missing_self_or_cls.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_mutable_params.py` & `codemodder-0.91.0/integration_tests/test_fix_mutable_params.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_fix_task_instantiation.py` & `codemodder-0.91.0/integration_tests/test_fix_task_instantiation.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_flask_enable_csrf_protection.py` & `codemodder-0.91.0/integration_tests/test_flask_enable_csrf_protection.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_flask_json_response_type.py` & `codemodder-0.91.0/integration_tests/test_flask_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_harden_pickle_load.py` & `codemodder-0.91.0/integration_tests/test_harden_pickle_load.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_harden_pyyaml.py` & `codemodder-0.91.0/integration_tests/test_harden_pyyaml.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_harden_ruamel.py` & `codemodder-0.91.0/integration_tests/test_harden_ruamel.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_https_connection.py` & `codemodder-0.91.0/integration_tests/test_https_connection.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_jinja2_autoescape.py` & `codemodder-0.91.0/integration_tests/test_jinja2_autoescape.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_jwt_decode_verify.py` & `codemodder-0.91.0/integration_tests/test_jwt_decode_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_lazy_logging.py` & `codemodder-0.91.0/integration_tests/test_lazy_logging.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_limit_readline.py` & `codemodder-0.91.0/integration_tests/test_limit_readline.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_literal_or_new_object_identity.py` & `codemodder-0.91.0/integration_tests/test_literal_or_new_object_identity.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_lxml_safe_parser_defaults.py` & `codemodder-0.91.0/integration_tests/test_lxml_safe_parser_defaults.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_lxml_safe_parsing.py` & `codemodder-0.91.0/integration_tests/test_lxml_safe_parsing.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_multiple_codemods.py` & `codemodder-0.91.0/integration_tests/test_multiple_codemods.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_numpy_nan_equality.py` & `codemodder-0.91.0/integration_tests/test_numpy_nan_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_order_imports.py` & `codemodder-0.91.0/integration_tests/test_order_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_process_sandbox.py` & `codemodder-0.91.0/integration_tests/test_process_sandbox.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_program.py` & `codemodder-0.91.0/integration_tests/test_program.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_remove_assertion_in_pytest_raises.py` & `codemodder-0.91.0/integration_tests/test_remove_assertion_in_pytest_raises.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_remove_debug_breakpoint.py` & `codemodder-0.91.0/integration_tests/test_remove_debug_breakpoint.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_remove_future_imports.py` & `codemodder-0.91.0/integration_tests/test_remove_future_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_remove_module_global.py` & `codemodder-0.91.0/integration_tests/test_remove_module_global.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_remove_unused_imports.py` & `codemodder-0.91.0/integration_tests/test_remove_unused_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_replace_flask_send_file.py` & `codemodder-0.91.0/integration_tests/test_replace_flask_send_file.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_request_verify.py` & `codemodder-0.91.0/integration_tests/test_request_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_secure_flask_cookie.py` & `codemodder-0.91.0/integration_tests/test_secure_flask_cookie.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_secure_flask_session_config.py` & `codemodder-0.91.0/integration_tests/test_secure_flask_session_config.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_secure_random.py` & `codemodder-0.91.0/integration_tests/test_secure_random.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_sql_parameterization.py` & `codemodder-0.91.0/integration_tests/test_sql_parameterization.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_str_concat_in_seq_literals.py` & `codemodder-0.91.0/integration_tests/test_str_concat_in_seq_literals.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_subprocess_shell_false.py` & `codemodder-0.91.0/integration_tests/test_subprocess_shell_false.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_tempfile_mktemp.py` & `codemodder-0.91.0/integration_tests/test_tempfile_mktemp.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_unnecessary_f_str.py` & `codemodder-0.91.0/integration_tests/test_unnecessary_f_str.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_upgrade_sslcontext_minimum_version.py` & `codemodder-0.91.0/integration_tests/test_upgrade_sslcontext_minimum_version.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_upgrade_sslcontext_tls.py` & `codemodder-0.91.0/integration_tests/test_upgrade_sslcontext_tls.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_url_sandbox.py` & `codemodder-0.91.0/integration_tests/test_url_sandbox.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_use_defusedxml.py` & `codemodder-0.91.0/integration_tests/test_use_defusedxml.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_use_generator.py` & `codemodder-0.91.0/integration_tests/test_use_generator.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_use_set_literal.py` & `codemodder-0.91.0/integration_tests/test_use_set_literal.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_use_walrus_if.py` & `codemodder-0.91.0/integration_tests/test_use_walrus_if.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/integration_tests/test_with_threading_lock.py` & `codemodder-0.91.0/integration_tests/test_with_threading_lock.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/pyproject.toml` & `codemodder-0.91.0/pyproject.toml`
...
### Comparing `codemodder-0.90.0/src/codemodder/cli.py` & `codemodder-0.91.0/src/codemodder/cli.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/code_directory.py` & `codemodder-0.91.0/src/codemodder/code_directory.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemodder.py` & `codemodder-0.91.0/src/codemodder/codemodder.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/api.py` & `codemodder-0.91.0/src/codemodder/codemods/api.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/base_codemod.py` & `codemodder-0.91.0/src/codemodder/codemods/base_codemod.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/base_transformer.py` & `codemodder-0.91.0/src/codemodder/codemods/base_transformer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/base_visitor.py` & `codemodder-0.91.0/src/codemodder/codemods/base_visitor.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/check_annotations.py` & `codemodder-0.91.0/src/codemodder/codemods/check_annotations.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/import_modifier_codemod.py` & `codemodder-0.91.0/src/codemodder/codemods/import_modifier_codemod.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/imported_call_modifier.py` & `codemodder-0.91.0/src/codemodder/codemods/imported_call_modifier.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/libcst_transformer.py` & `codemodder-0.91.0/src/codemodder/codemods/libcst_transformer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/semgrep.py` & `codemodder-0.91.0/src/codemodder/codemods/semgrep.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/test/integration_utils.py` & `codemodder-0.91.0/src/codemodder/codemods/test/integration_utils.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/test/utils.py` & `codemodder-0.91.0/src/codemodder/codemods/test/utils.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/test/validations.py` & `codemodder-0.91.0/src/codemodder/codemods/test/validations.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/transformations/clean_imports.py` & `codemodder-0.91.0/src/codemodder/codemods/transformations/clean_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/transformations/remove_empty_string_concatenation.py` & `codemodder-0.91.0/src/codemodder/codemods/transformations/remove_empty_string_concatenation.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/transformations/remove_unused_imports.py` & `codemodder-0.91.0/src/codemodder/codemods/transformations/remove_unused_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/utils.py` & `codemodder-0.91.0/src/codemodder/codemods/utils.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codemods/utils_mixin.py` & `codemodder-0.91.0/src/codemodder/codemods/utils_mixin.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/codetf.py` & `codemodder-0.91.0/src/codemodder/codetf.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/context.py` & `codemodder-0.91.0/src/codemodder/context.py`
...
### Comparing `codemodder-0.90.0/src/codemodder/dependency.py` & `codemodder-0.91.0/src/codemodder/dependency.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/dependency_management/base_dependency_writer.py` & `codemodder-0.91.0/src/codemodder/dependency_management/base_dependency_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/dependency_management/dependency_manager.py` & `codemodder-0.91.0/src/codemodder/dependency_management/dependency_manager.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/dependency_management/pyproject_writer.py` & `codemodder-0.91.0/src/codemodder/dependency_management/pyproject_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/dependency_management/requirements_txt_writer.py` & `codemodder-0.91.0/src/codemodder/dependency_management/requirements_txt_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/dependency_management/setup_py_writer.py` & `codemodder-0.91.0/src/codemodder/dependency_management/setup_py_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/dependency_management/setupcfg_writer.py` & `codemodder-0.91.0/src/codemodder/dependency_management/setupcfg_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/diff.py` & `codemodder-0.91.0/src/codemodder/diff.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/file_context.py` & `codemodder-0.91.0/src/codemodder/file_context.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/logging.py` & `codemodder-0.91.0/src/codemodder/logging.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/project_analysis/file_parsers/base_parser.py` & `codemodder-0.91.0/src/codemodder/project_analysis/file_parsers/base_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/project_analysis/file_parsers/package_store.py` & `codemodder-0.91.0/src/codemodder/project_analysis/file_parsers/package_store.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/project_analysis/file_parsers/pyproject_toml_file_parser.py` & `codemodder-0.91.0/src/codemodder/project_analysis/file_parsers/pyproject_toml_file_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/project_analysis/file_parsers/requirements_txt_file_parser.py` & `codemodder-0.91.0/src/codemodder/project_analysis/file_parsers/requirements_txt_file_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/project_analysis/file_parsers/setup_cfg_file_parser.py` & `codemodder-0.91.0/src/codemodder/project_analysis/file_parsers/setup_cfg_file_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/project_analysis/file_parsers/setup_py_file_parser.py` & `codemodder-0.91.0/src/codemodder/project_analysis/file_parsers/setup_py_file_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/project_analysis/python_repo_manager.py` & `codemodder-0.91.0/src/codemodder/project_analysis/python_repo_manager.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/registry.py` & `codemodder-0.91.0/src/codemodder/registry.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/result.py` & `codemodder-0.91.0/src/codemodder/result.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/sarifs.py` & `codemodder-0.91.0/src/codemodder/sarifs.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/scripts/generate_docs.py` & `codemodder-0.91.0/src/codemodder/scripts/generate_docs.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/scripts/get_hashes.py` & `codemodder-0.91.0/src/codemodder/scripts/get_hashes.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/semgrep.py` & `codemodder-0.91.0/src/codemodder/semgrep.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/utils/clean_code.py` & `codemodder-0.91.0/src/codemodder/utils/clean_code.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/utils/format_string_parser.py` & `codemodder-0.91.0/src/codemodder/utils/format_string_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/utils/linearize_string_expression.py` & `codemodder-0.91.0/src/codemodder/utils/linearize_string_expression.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/utils/timer.py` & `codemodder-0.91.0/src/codemodder/utils/timer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder/utils/utils.py` & `codemodder-0.91.0/src/codemodder/utils/utils.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder.egg-info/PKG-INFO` & `codemodder-0.91.0/src/codemodder.egg-info/PKG-INFO`
...
### Comparing `codemodder-0.90.0/src/codemodder.egg-info/SOURCES.txt` & `codemodder-0.91.0/src/codemodder.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/codemodder.egg-info/requires.txt` & `codemodder-0.91.0/src/codemodder.egg-info/requires.txt`
...
### Comparing `codemodder-0.90.0/src/core_codemods/__init__.py` & `codemodder-0.91.0/src/core_codemods/__init__.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/add_requests_timeouts.py` & `codemodder-0.91.0/src/core_codemods/add_requests_timeouts.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/api/core_codemod.py` & `codemodder-0.91.0/src/core_codemods/api/core_codemod.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/combine_startswith_endswith.py` & `codemodder-0.91.0/src/core_codemods/combine_startswith_endswith.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/defectdojo/api.py` & `codemodder-0.91.0/src/core_codemods/defectdojo/api.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/defectdojo/results.py` & `codemodder-0.91.0/src/core_codemods/defectdojo/results.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/defectdojo/semgrep/avoid_insecure_deserialization.py` & `codemodder-0.91.0/src/core_codemods/defectdojo/semgrep/avoid_insecure_deserialization.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/defectdojo/semgrep/django_secure_set_cookie.py` & `codemodder-0.91.0/src/core_codemods/defectdojo/semgrep/django_secure_set_cookie.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/django_debug_flag_on.py` & `codemodder-0.91.0/src/core_codemods/django_debug_flag_on.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/django_json_response_type.py` & `codemodder-0.91.0/src/core_codemods/django_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/django_model_without_dunder_str.py` & `codemodder-0.91.0/src/core_codemods/django_model_without_dunder_str.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/django_receiver_on_top.py` & `codemodder-0.91.0/src/core_codemods/django_receiver_on_top.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/django_session_cookie_secure_off.py` & `codemodder-0.91.0/src/core_codemods/django_session_cookie_secure_off.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/defectdojo_python_avoid-insecure-deserialization.md` & `codemodder-0.91.0/src/core_codemods/docs/defectdojo_python_avoid-insecure-deserialization.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/defectdojo_python_django-secure-set-cookie.md` & `codemodder-0.91.0/src/core_codemods/docs/defectdojo_python_django-secure-set-cookie.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_add-requests-timeouts.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_add-requests-timeouts.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_bad-lock-with-statement.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_bad-lock-with-statement.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_combine-startswith-endswith.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_combine-startswith-endswith.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_django-json-response-type.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_django-json-response-type.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_django-model-without-dunder-str.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_django-model-without-dunder-str.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_django-receiver-on-top.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_django-receiver-on-top.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_enable-jinja2-autoescape.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_enable-jinja2-autoescape.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_fix-dataclass-defaults.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_fix-dataclass-defaults.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_fix-deprecated-abstractproperty.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_fix-deprecated-abstractproperty.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_fix-deprecated-logging-warn.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_fix-deprecated-logging-warn.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_fix-empty-sequence-comparison.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_fix-empty-sequence-comparison.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_fix-file-resource-leak.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_fix-file-resource-leak.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_fix-float-equality.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_fix-float-equality.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_fix-mutable-params.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_fix-mutable-params.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_flask-enable-csrf-protection.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_flask-enable-csrf-protection.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_flask-json-response-type.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_flask-json-response-type.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_harden-pickle-load.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_harden-pickle-load.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_harden-pyyaml.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_harden-pyyaml.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_harden-ruamel.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_harden-ruamel.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_jwt-decode-verify.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_jwt-decode-verify.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_lazy-logging.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_lazy-logging.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_limit-readline.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_limit-readline.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_remove-assertion-in-pytest-raises.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_remove-assertion-in-pytest-raises.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_remove-future-imports.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_remove-future-imports.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_replace-flask-send-file.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_replace-flask-send-file.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_requests-verify.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_requests-verify.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_safe-lxml-parser-defaults.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_safe-lxml-parser-defaults.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_safe-lxml-parsing.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_safe-lxml-parsing.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_sandbox-process-creation.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_sandbox-process-creation.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_secure-flask-cookie.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_secure-flask-cookie.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_secure-flask-session-configuration.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_secure-flask-session-configuration.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_secure-random.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_secure-random.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_sql-parameterization.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_sql-parameterization.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_subprocess-shell-false.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_subprocess-shell-false.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_upgrade-sslcontext-minimum-version.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_upgrade-sslcontext-minimum-version.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_upgrade-sslcontext-tls.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_upgrade-sslcontext-tls.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_url-sandbox.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_url-sandbox.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_use-defusedxml.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_use-defusedxml.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_use-generator.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_use-generator.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/docs/pixee_python_use-walrus-if.md` & `codemodder-0.91.0/src/core_codemods/docs/pixee_python_use-walrus-if.md`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/enable_jinja2_autoescape.py` & `codemodder-0.91.0/src/core_codemods/enable_jinja2_autoescape.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/exception_without_raise.py` & `codemodder-0.91.0/src/core_codemods/exception_without_raise.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/file_resource_leak.py` & `codemodder-0.91.0/src/core_codemods/file_resource_leak.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_assert_tuple.py` & `codemodder-0.91.0/src/core_codemods/fix_assert_tuple.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_async_task_instantiation.py` & `codemodder-0.91.0/src/core_codemods/fix_async_task_instantiation.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_dataclass_defaults.py` & `codemodder-0.91.0/src/core_codemods/fix_dataclass_defaults.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_deprecated_abstractproperty.py` & `codemodder-0.91.0/src/core_codemods/fix_deprecated_abstractproperty.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_deprecated_logging_warn.py` & `codemodder-0.91.0/src/core_codemods/fix_deprecated_logging_warn.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_empty_sequence_comparison.py` & `codemodder-0.91.0/src/core_codemods/fix_empty_sequence_comparison.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_float_equality.py` & `codemodder-0.91.0/src/core_codemods/fix_float_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_hasattr_call.py` & `codemodder-0.91.0/src/core_codemods/fix_hasattr_call.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_missing_self_or_cls.py` & `codemodder-0.91.0/src/core_codemods/fix_missing_self_or_cls.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/fix_mutable_params.py` & `codemodder-0.91.0/src/core_codemods/fix_mutable_params.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/flask_enable_csrf_protection.py` & `codemodder-0.91.0/src/core_codemods/flask_enable_csrf_protection.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/flask_json_response_type.py` & `codemodder-0.91.0/src/core_codemods/flask_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/harden_pickle_load.py` & `codemodder-0.91.0/src/core_codemods/harden_pickle_load.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/harden_pyyaml.py` & `codemodder-0.91.0/src/core_codemods/harden_pyyaml.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/harden_ruamel.py` & `codemodder-0.91.0/src/core_codemods/harden_ruamel.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/https_connection.py` & `codemodder-0.91.0/src/core_codemods/https_connection.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/jwt_decode_verify.py` & `codemodder-0.91.0/src/core_codemods/jwt_decode_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/lazy_logging.py` & `codemodder-0.91.0/src/core_codemods/lazy_logging.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/limit_readline.py` & `codemodder-0.91.0/src/core_codemods/limit_readline.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/literal_or_new_object_identity.py` & `codemodder-0.91.0/src/core_codemods/literal_or_new_object_identity.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/lxml_safe_parser_defaults.py` & `codemodder-0.91.0/src/core_codemods/lxml_safe_parser_defaults.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/lxml_safe_parsing.py` & `codemodder-0.91.0/src/core_codemods/lxml_safe_parsing.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/numpy_nan_equality.py` & `codemodder-0.91.0/src/core_codemods/numpy_nan_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/order_imports.py` & `codemodder-0.91.0/src/core_codemods/order_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/process_creation_sandbox.py` & `codemodder-0.91.0/src/core_codemods/process_creation_sandbox.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/refactor/refactor_new_api.py` & `codemodder-0.91.0/src/core_codemods/refactor/refactor_new_api.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/remove_assertion_in_pytest_raises.py` & `codemodder-0.91.0/src/core_codemods/remove_assertion_in_pytest_raises.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/remove_debug_breakpoint.py` & `codemodder-0.91.0/src/core_codemods/remove_debug_breakpoint.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/remove_future_imports.py` & `codemodder-0.91.0/src/core_codemods/remove_future_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/remove_module_global.py` & `codemodder-0.91.0/src/core_codemods/remove_module_global.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/remove_unnecessary_f_str.py` & `codemodder-0.91.0/src/core_codemods/remove_unnecessary_f_str.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/remove_unused_imports.py` & `codemodder-0.91.0/src/core_codemods/remove_unused_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/replace_flask_send_file.py` & `codemodder-0.91.0/src/core_codemods/replace_flask_send_file.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/requests_verify.py` & `codemodder-0.91.0/src/core_codemods/requests_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/secure_cookie_mixin.py` & `codemodder-0.91.0/src/core_codemods/secure_cookie_mixin.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/secure_flask_cookie.py` & `codemodder-0.91.0/src/core_codemods/secure_flask_cookie.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/secure_flask_session_config.py` & `codemodder-0.91.0/src/core_codemods/secure_flask_session_config.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/secure_random.py` & `codemodder-0.91.0/src/core_codemods/secure_random.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/sonar/api.py` & `codemodder-0.91.0/src/core_codemods/sonar/api.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/sonar/results.py` & `codemodder-0.91.0/src/core_codemods/sonar/results.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/sonar/sonar_jwt_decode_verify.py` & `codemodder-0.91.0/src/core_codemods/sonar/sonar_jwt_decode_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/sql_parameterization.py` & `codemodder-0.91.0/src/core_codemods/sql_parameterization.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/str_concat_in_seq_literal.py` & `codemodder-0.91.0/src/core_codemods/str_concat_in_seq_literal.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/subprocess_shell_false.py` & `codemodder-0.91.0/src/core_codemods/subprocess_shell_false.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/tempfile_mktemp.py` & `codemodder-0.91.0/src/core_codemods/tempfile_mktemp.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/upgrade_sslcontext_minimum_version.py` & `codemodder-0.91.0/src/core_codemods/upgrade_sslcontext_minimum_version.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/upgrade_sslcontext_tls.py` & `codemodder-0.91.0/src/core_codemods/upgrade_sslcontext_tls.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/url_sandbox.py` & `codemodder-0.91.0/src/core_codemods/url_sandbox.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/use_defused_xml.py` & `codemodder-0.91.0/src/core_codemods/use_defused_xml.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/use_generator.py` & `codemodder-0.91.0/src/core_codemods/use_generator.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/use_set_literal.py` & `codemodder-0.91.0/src/core_codemods/use_set_literal.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/use_walrus_if.py` & `codemodder-0.91.0/src/core_codemods/use_walrus_if.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/src/core_codemods/with_threading_lock.py` & `codemodder-0.91.0/src/core_codemods/with_threading_lock.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/defectdojo/semgrep/test_avoid_insecure_deserialization.py` & `codemodder-0.91.0/tests/codemods/defectdojo/semgrep/test_avoid_insecure_deserialization.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/defectdojo/semgrep/test_django_secure_set_cookie.py` & `codemodder-0.91.0/tests/codemods/defectdojo/semgrep/test_django_secure_set_cookie.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_django_json_response_type.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_django_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_django_receiver_on_top.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_django_receiver_on_top.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_enable_jinja2_autoescape.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_enable_jinja2_autoescape.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_exception_without_raise.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_exception_without_raise.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_fix_assert_tuple.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_fix_assert_tuple.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_fix_float_equality.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_fix_float_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_fix_missing_self_or_cls.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_fix_missing_self_or_cls.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_flask_json_response_type.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_flask_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_jwt_decode_verify.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_jwt_decode_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_literal_or_new_object_identity.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_literal_or_new_object_identity.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_numpy_nan_equality.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_numpy_nan_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_remove_assertion_in_pytest_raises.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_remove_assertion_in_pytest_raises.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_secure_random.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_secure_random.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_tempfile_mktemp.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_tempfile_mktemp.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/sonar/test_sonar_url_sandbox.py` & `codemodder-0.91.0/tests/codemods/sonar/test_sonar_url_sandbox.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_add_requests_timeouts.py` & `codemodder-0.91.0/tests/codemods/test_add_requests_timeouts.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_async_fix_task_instantiation.py` & `codemodder-0.91.0/tests/codemods/test_async_fix_task_instantiation.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_base_codemod.py` & `codemodder-0.91.0/tests/codemods/test_base_codemod.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_base_visitor.py` & `codemodder-0.91.0/tests/codemods/test_base_visitor.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_combine_startswith_endswith.py` & `codemodder-0.91.0/tests/codemods/test_combine_startswith_endswith.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_django_debug_flag_on.py` & `codemodder-0.91.0/tests/codemods/test_django_debug_flag_on.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_django_json_response_type.py` & `codemodder-0.91.0/tests/codemods/test_django_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_django_model_without_dunder_str.py` & `codemodder-0.91.0/tests/codemods/test_django_model_without_dunder_str.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_django_receiver_on_top.py` & `codemodder-0.91.0/tests/codemods/test_django_receiver_on_top.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_django_session_cookie_secure_off.py` & `codemodder-0.91.0/tests/codemods/test_django_session_cookie_secure_off.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_enable_jinja2_autoescape.py` & `codemodder-0.91.0/tests/codemods/test_enable_jinja2_autoescape.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_exception_without_raise.py` & `codemodder-0.91.0/tests/codemods/test_exception_without_raise.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_file_resource_leak.py` & `codemodder-0.91.0/tests/codemods/test_file_resource_leak.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_assert_tuple.py` & `codemodder-0.91.0/tests/codemods/test_fix_assert_tuple.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_dataclass_defaults.py` & `codemodder-0.91.0/tests/codemods/test_fix_dataclass_defaults.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_deprecated_abstractproperty.py` & `codemodder-0.91.0/tests/codemods/test_fix_deprecated_abstractproperty.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_deprecated_logging_warn.py` & `codemodder-0.91.0/tests/codemods/test_fix_deprecated_logging_warn.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_empty_sequence_comparison.py` & `codemodder-0.91.0/tests/codemods/test_fix_empty_sequence_comparison.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_float_equality.py` & `codemodder-0.91.0/tests/codemods/test_fix_float_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_hasattr_call.py` & `codemodder-0.91.0/tests/codemods/test_fix_hasattr_call.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_missing_self_or_cls.py` & `codemodder-0.91.0/tests/codemods/test_fix_missing_self_or_cls.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_fix_mutable_params.py` & `codemodder-0.91.0/tests/codemods/test_fix_mutable_params.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_flask_enable_csrf_protection.py` & `codemodder-0.91.0/tests/codemods/test_flask_enable_csrf_protection.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_flask_json_response_type.py` & `codemodder-0.91.0/tests/codemods/test_flask_json_response_type.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_harden_pickle_load.py` & `codemodder-0.91.0/tests/codemods/test_harden_pickle_load.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_harden_pyyaml.py` & `codemodder-0.91.0/tests/codemods/test_harden_pyyaml.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_harden_ruamel.py` & `codemodder-0.91.0/tests/codemods/test_harden_ruamel.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_https_connection.py` & `codemodder-0.91.0/tests/codemods/test_https_connection.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_include_exclude.py` & `codemodder-0.91.0/tests/codemods/test_include_exclude.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_jwt_decode_verify.py` & `codemodder-0.91.0/tests/codemods/test_jwt_decode_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_lazy_logging.py` & `codemodder-0.91.0/tests/codemods/test_lazy_logging.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_limit_readline.py` & `codemodder-0.91.0/tests/codemods/test_limit_readline.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_literal_or_new_object_identity.py` & `codemodder-0.91.0/tests/codemods/test_literal_or_new_object_identity.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_lxml_safe_parameter_defaults.py` & `codemodder-0.91.0/tests/codemods/test_lxml_safe_parameter_defaults.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_lxml_safe_parsing.py` & `codemodder-0.91.0/tests/codemods/test_lxml_safe_parsing.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_numpy_nan_equality.py` & `codemodder-0.91.0/tests/codemods/test_numpy_nan_equality.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_order_imports.py` & `codemodder-0.91.0/tests/codemods/test_order_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_process_creation_sandbox.py` & `codemodder-0.91.0/tests/codemods/test_process_creation_sandbox.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_remove_assertion_in_pytest_raises.py` & `codemodder-0.91.0/tests/codemods/test_remove_assertion_in_pytest_raises.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_remove_debug_breakpoint.py` & `codemodder-0.91.0/tests/codemods/test_remove_debug_breakpoint.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_remove_future_imports.py` & `codemodder-0.91.0/tests/codemods/test_remove_future_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_remove_module_global.py` & `codemodder-0.91.0/tests/codemods/test_remove_module_global.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_remove_unnecessary_f_str.py` & `codemodder-0.91.0/tests/codemods/test_remove_unnecessary_f_str.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_remove_unused_imports.py` & `codemodder-0.91.0/tests/codemods/test_remove_unused_imports.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_replace_flask_send_file.py` & `codemodder-0.91.0/tests/codemods/test_replace_flask_send_file.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_request_verify.py` & `codemodder-0.91.0/tests/codemods/test_request_verify.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_secure_flask_cookie.py` & `codemodder-0.91.0/tests/codemods/test_secure_flask_cookie.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_secure_flask_session_config.py` & `codemodder-0.91.0/tests/codemods/test_secure_flask_session_config.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_secure_random.py` & `codemodder-0.91.0/tests/codemods/test_secure_random.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_sql_parameterization.py` & `codemodder-0.91.0/tests/codemods/test_sql_parameterization.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_str_concat_in_seq_literal.py` & `codemodder-0.91.0/tests/codemods/test_str_concat_in_seq_literal.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_subprocess_shell_false.py` & `codemodder-0.91.0/tests/codemods/test_subprocess_shell_false.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_tempfile_mktemp.py` & `codemodder-0.91.0/tests/codemods/test_tempfile_mktemp.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_upgrade_sslcontext_minimum_version.py` & `codemodder-0.91.0/tests/codemods/test_upgrade_sslcontext_minimum_version.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_upgrade_sslcontext_tls.py` & `codemodder-0.91.0/tests/codemods/test_upgrade_sslcontext_tls.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_url_sandbox.py` & `codemodder-0.91.0/tests/codemods/test_url_sandbox.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_use_defused_xml.py` & `codemodder-0.91.0/tests/codemods/test_use_defused_xml.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_use_generator.py` & `codemodder-0.91.0/tests/codemods/test_use_generator.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_use_set_literal.py` & `codemodder-0.91.0/tests/codemods/test_use_set_literal.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_walrus_if.py` & `codemodder-0.91.0/tests/codemods/test_walrus_if.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/codemods/test_with_threading_lock.py` & `codemodder-0.91.0/tests/codemods/test_with_threading_lock.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/conftest.py` & `codemodder-0.91.0/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/dependency_management/test_base_dependency_writer.py` & `codemodder-0.91.0/tests/dependency_management/test_base_dependency_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/dependency_management/test_dependency_manager.py` & `codemodder-0.91.0/tests/dependency_management/test_dependency_manager.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/dependency_management/test_pyproject_writer.py` & `codemodder-0.91.0/tests/dependency_management/test_pyproject_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/dependency_management/test_requirements_txt_writer.py` & `codemodder-0.91.0/tests/dependency_management/test_requirements_txt_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/dependency_management/test_setup_py_writer.py` & `codemodder-0.91.0/tests/dependency_management/test_setup_py_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/dependency_management/test_setupcfgt_writer.py` & `codemodder-0.91.0/tests/dependency_management/test_setupcfgt_writer.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/project_analysis/file_parsers/test_pyproject_toml_file_parser.py` & `codemodder-0.91.0/tests/project_analysis/file_parsers/test_pyproject_toml_file_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/project_analysis/file_parsers/test_requirements_txt_file_parser.py` & `codemodder-0.91.0/tests/project_analysis/file_parsers/test_requirements_txt_file_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/project_analysis/file_parsers/test_setup_cfg_file_parser.py` & `codemodder-0.91.0/tests/project_analysis/file_parsers/test_setup_cfg_file_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/project_analysis/file_parsers/test_setup_py_file_parser.py` & `codemodder-0.91.0/tests/project_analysis/file_parsers/test_setup_py_file_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/samples/pygoat.semgrep.sarif.json` & `codemodder-0.91.0/tests/samples/pygoat.semgrep.sarif.json`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/samples/semgrep.sarif` & `codemodder-0.91.0/tests/samples/semgrep.sarif`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/samples/sonar_hotspots.json` & `codemodder-0.91.0/tests/samples/sonar_hotspots.json`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/samples/sonar_issues.json` & `codemodder-0.91.0/tests/samples/sonar_issues.json`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/samples/webgoat_v8.2.0_codeql.sarif` & `codemodder-0.91.0/tests/samples/webgoat_v8.2.0_codeql.sarif`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_ancestorpatterns_mixin.py` & `codemodder-0.91.0/tests/test_ancestorpatterns_mixin.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_basetype.py` & `codemodder-0.91.0/tests/test_basetype.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_cli.py` & `codemodder-0.91.0/tests/test_cli.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_code_directory.py` & `codemodder-0.91.0/tests/test_code_directory.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_codemod_docs.py` & `codemodder-0.91.0/tests/test_codemod_docs.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_codemodder.py` & `codemodder-0.91.0/tests/test_codemodder.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_codetf.py` & `codemodder-0.91.0/tests/test_codetf.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_context.py` & `codemodder-0.91.0/tests/test_context.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_format_string_parser.py` & `codemodder-0.91.0/tests/test_format_string_parser.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_linearize_string_expression.py` & `codemodder-0.91.0/tests/test_linearize_string_expression.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_logging.py` & `codemodder-0.91.0/tests/test_logging.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_nameresolution_mixin.py` & `codemodder-0.91.0/tests/test_nameresolution_mixin.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_results.py` & `codemodder-0.91.0/tests/test_results.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_sarif_processing.py` & `codemodder-0.91.0/tests/test_sarif_processing.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/test_semgrep.py` & `codemodder-0.91.0/tests/test_semgrep.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/transformations/test_clean_code.py` & `codemodder-0.91.0/tests/transformations/test_clean_code.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/transformations/test_remove_empty_string_concatenation.py` & `codemodder-0.91.0/tests/transformations/test_remove_empty_string_concatenation.py`

 * *Files identical despite different names*

### Comparing `codemodder-0.90.0/tests/transformations/test_remove_unused_imports.py` & `codemodder-0.91.0/tests/transformations/test_remove_unused_imports.py`
