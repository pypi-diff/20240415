# Comparing `tmp/gptstonks_wrappers-0.0.1.post1.tar.gz` & `tmp/gptstonks_wrappers-0.0.1b0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gptstonks_wrappers-0.0.1.post1.tar", last modified: Mon Apr 15 20:08:28 2024, max compression
+gzip compressed data, was "gptstonks_wrappers-0.0.1b0.tar", last modified: Mon Apr 15 17:13:21 2024, max compression
```

## Comparing `gptstonks_wrappers-0.0.1.post1.tar` & `gptstonks_wrappers-0.0.1b0.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     2812 2024-04-15 16:48:42.259960 gptstonks_wrappers-0.0.1.post1/README.md
--rw-r--r--   0        0        0     1725 2024-04-15 20:08:28.009636 gptstonks_wrappers-0.0.1.post1/pyproject.toml
--rw-r--r--   0        0        0       28 2024-04-15 17:02:37.148728 gptstonks_wrappers-0.0.1.post1/tests/env.sh
--rw-r--r--   0        0        0     5700 2024-04-15 16:40:42.021406 gptstonks_wrappers-0.0.1.post1/tests/kernels/test_auto_llama_index.py
--rw-r--r--   0        0        0     3553 2024-04-15 16:40:42.024739 gptstonks_wrappers-0.0.1.post1/tests/kernels/test_auto_multistep_query_engine.py
--rw-r--r--   0        0        0      566 2024-04-15 16:40:42.028072 gptstonks_wrappers-0.0.1.post1/tests/llms/test_chat_model_llm_iface.py
--rw-r--r--   0        0        0      311 2024-04-13 11:16:30.507370 gptstonks_wrappers-0.0.1.post1/tests/llms/test_guidance_wrapper.py
--rw-r--r--   0        0        0     4663 1970-01-01 00:00:00.000000 gptstonks_wrappers-0.0.1.post1/PKG-INFO
...
### Comparing `gptstonks_wrappers-0.0.1.post1/README.md` & `gptstonks_wrappers-0.0.1b0/README.md`

 * *Files identical despite different names*

### Comparing `gptstonks_wrappers-0.0.1.post1/pyproject.toml` & `gptstonks_wrappers-0.0.1b0/pyproject.toml`
...
### Comparing `gptstonks_wrappers-0.0.1.post1/tests/kernels/test_auto_llama_index.py` & `gptstonks_wrappers-0.0.1b0/tests/kernels/test_auto_llama_index.py`

 * *Files identical despite different names*

### Comparing `gptstonks_wrappers-0.0.1.post1/tests/kernels/test_auto_multistep_query_engine.py` & `gptstonks_wrappers-0.0.1b0/tests/kernels/test_auto_multistep_query_engine.py`

 * *Files identical despite different names*

### Comparing `gptstonks_wrappers-0.0.1.post1/tests/llms/test_chat_model_llm_iface.py` & `gptstonks_wrappers-0.0.1b0/tests/llms/test_chat_model_llm_iface.py`

 * *Files identical despite different names*

### Comparing `gptstonks_wrappers-0.0.1.post1/PKG-INFO` & `gptstonks_wrappers-0.0.1b0/PKG-INFO`
...
```diff
@@ -1,32 +1,33 @@
-Metadata-Version: 2.1 Name: gptstonks-wrappers Version: 0.0.1.post1 Summary:
