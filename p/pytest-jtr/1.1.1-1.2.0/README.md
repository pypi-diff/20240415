# Comparing `tmp/pytest-jtr-1.1.1.tar.gz` & `tmp/pytest_jtr-1.2.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pytest-jtr-1.1.1.tar", max compression
+gzip compressed data, was "pytest_jtr-1.2.0.tar", max compression
```

## Comparing `pytest-jtr-1.1.1.tar` & `pytest_jtr-1.2.0.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     1065 2022-06-18 09:49:16.036455 pytest-jtr-1.1.1/LICENSE
--rw-r--r--   0        0        0    14183 2022-11-28 15:55:35.590799 pytest-jtr-1.1.1/README.md
--rw-r--r--   0        0        0     1205 2022-11-29 11:11:50.456609 pytest-jtr-1.1.1/pyproject.toml
--rw-r--r--   0        0        0        0 2022-06-20 19:38:58.571181 pytest-jtr-1.1.1/pytest_jtr/__init__.py
--rw-r--r--   0        0        0    15145 2022-11-29 10:12:13.791017 pytest-jtr-1.1.1/pytest_jtr/plugin.py
--rw-r--r--   0        0        0     3732 2022-11-29 10:20:09.793631 pytest-jtr-1.1.1/pytest_jtr/serialize.py
--rw-r--r--   0        0        0    15969 2022-11-29 11:11:51.718242 pytest-jtr-1.1.1/setup.py
--rw-r--r--   0        0        0    14983 2022-11-29 11:11:51.719104 pytest-jtr-1.1.1/PKG-INFO
+-rw-r--r--   0        0        0     1065 2022-06-18 09:49:16.036455 pytest_jtr-1.2.0/LICENSE
+-rw-r--r--   0        0        0    14183 2022-11-28 15:55:35.590799 pytest_jtr-1.2.0/README.md
+-rw-r--r--   0        0        0     1205 2024-04-15 10:31:06.803162 pytest_jtr-1.2.0/pyproject.toml
+-rw-r--r--   0        0        0        0 2022-06-20 19:38:58.571181 pytest_jtr-1.2.0/pytest_jtr/__init__.py
+-rw-r--r--   0        0        0    15145 2022-12-05 23:23:11.647837 pytest_jtr-1.2.0/pytest_jtr/plugin.py
+-rw-r--r--   0        0        0     3732 2022-12-05 23:23:11.648896 pytest_jtr-1.2.0/pytest_jtr/serialize.py
+-rw-r--r--   0        0        0    15975 1970-01-01 00:00:00.000000 pytest_jtr-1.2.0/setup.py
+-rw-r--r--   0        0        0    14983 1970-01-01 00:00:00.000000 pytest_jtr-1.2.0/PKG-INFO
```

### Comparing `pytest-jtr-1.1.1/LICENSE` & `pytest_jtr-1.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `pytest-jtr-1.1.1/README.md` & `pytest_jtr-1.2.0/README.md`

 * *Files identical despite different names*

### Comparing `pytest-jtr-1.1.1/pyproject.toml` & `pytest_jtr-1.2.0/pyproject.toml`
...
### Comparing `pytest-jtr-1.1.1/pytest_jtr/plugin.py` & `pytest_jtr-1.2.0/pytest_jtr/plugin.py`

 * *Files identical despite different names*

### Comparing `pytest-jtr-1.1.1/pytest_jtr/serialize.py` & `pytest_jtr-1.2.0/pytest_jtr/serialize.py`

 * *Files identical despite different names*

### Comparing `pytest-jtr-1.1.1/setup.py` & `pytest_jtr-1.2.0/setup.py`
...
### Comparing `pytest-jtr-1.1.1/PKG-INFO` & `pytest_jtr-1.2.0/PKG-INFO`
...
+Classifier: Programming Language :: Python :: 3.10
 ...
 Requires-Dist: pytest-metadata (>=2.0.1,<3.0.0)
