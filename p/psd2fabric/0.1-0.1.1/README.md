# Comparing `tmp/psd2fabric-0.1.tar.gz` & `tmp/psd2fabric-0.1.1.tar.gz`
...
## Comparing `psd2fabric-0.1.tar` & `psd2fabric-0.1.1.tar`
...
### Comparing `psd2fabric-0.1/README.md` & `psd2fabric-0.1.1/README.md`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.1/psd2fabric/fabric/__init__.py` & `psd2fabric-0.1.1/psd2fabric/fabric/__init__.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.1/psd2fabric/fabric/group.py` & `psd2fabric-0.1.1/psd2fabric/fabric/group.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.1/psd2fabric/fabric/text.py` & `psd2fabric-0.1.1/psd2fabric/fabric/text.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.1/psd2fabric/parser/image_parser.py` & `psd2fabric-0.1.1/psd2fabric/parser/image_parser.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.1/psd2fabric/parser/psd_parser.py` & `psd2fabric-0.1.1/psd2fabric/parser/psd_parser.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.1/psd2fabric/parser/type_parser.py` & `psd2fabric-0.1.1/psd2fabric/parser/type_parser.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.1/psd2fabric.egg-info/SOURCES.txt` & `psd2fabric-0.1.1/psd2fabric.egg-info/SOURCES.txt`
