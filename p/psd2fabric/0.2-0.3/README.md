# Comparing `tmp/psd2fabric-0.2.tar.gz` & `tmp/psd2fabric-0.3.tar.gz`
...
## Comparing `psd2fabric-0.2.tar` & `psd2fabric-0.3.tar`
...
### Comparing `psd2fabric-0.2/README.md` & `psd2fabric-0.3/README.md`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.2/psd2fabric/fabric/__init__.py` & `psd2fabric-0.3/psd2fabric/fabric/__init__.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.2/psd2fabric/fabric/group.py` & `psd2fabric-0.3/psd2fabric/fabric/group.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.2/psd2fabric/fabric/text.py` & `psd2fabric-0.3/psd2fabric/fabric/text.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.2/psd2fabric/parser/image_parser.py` & `psd2fabric-0.3/psd2fabric/parser/image_parser.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.2/psd2fabric/parser/psd_parser.py` & `psd2fabric-0.3/psd2fabric/parser/psd_parser.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.2/psd2fabric/parser/type_parser.py` & `psd2fabric-0.3/psd2fabric/parser/type_parser.py`

 * *Files identical despite different names*

### Comparing `psd2fabric-0.2/psd2fabric.egg-info/SOURCES.txt` & `psd2fabric-0.3/psd2fabric.egg-info/SOURCES.txt`
