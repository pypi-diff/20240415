# Comparing `tmp/pylabeladjust-0.1.1.3.tar.gz` & `tmp/pylabeladjust-0.1.1.4.tar.gz`
...
## Comparing `pylabeladjust-0.1.1.3.tar` & `pylabeladjust-0.1.1.4.tar`
...
### Comparing `pylabeladjust-0.1.1.3/LICENSE` & `pylabeladjust-0.1.1.4/LICENSE`

 * *Files identical despite different names*

### Comparing `pylabeladjust-0.1.1.3/README.md` & `pylabeladjust-0.1.1.4/README.md`
...
### Comparing `pylabeladjust-0.1.1.3/pylabeladjust/core.py` & `pylabeladjust-0.1.1.4/pylabeladjust/core.py`

 * *Files identical despite different names*

### Comparing `pylabeladjust-0.1.1.3/PKG-INFO` & `pylabeladjust-0.1.1.4/PKG-INFO`
