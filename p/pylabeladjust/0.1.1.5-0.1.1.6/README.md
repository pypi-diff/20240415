# Comparing `tmp/pylabeladjust-0.1.1.5.tar.gz` & `tmp/pylabeladjust-0.1.1.6.tar.gz`
...
## Comparing `pylabeladjust-0.1.1.5.tar` & `pylabeladjust-0.1.1.6.tar`
...
### Comparing `pylabeladjust-0.1.1.5/LICENSE` & `pylabeladjust-0.1.1.6/LICENSE`

 * *Files identical despite different names*

### Comparing `pylabeladjust-0.1.1.5/README.md` & `pylabeladjust-0.1.1.6/README.md`
...
### Comparing `pylabeladjust-0.1.1.5/pylabeladjust/core.py` & `pylabeladjust-0.1.1.6/pylabeladjust/core.py`

 * *Files identical despite different names*

### Comparing `pylabeladjust-0.1.1.5/PKG-INFO` & `pylabeladjust-0.1.1.6/PKG-INFO`
